...
The current public release is [`v0.1.19-bastion`](https://github.com/qinyongliang/gosshd-bastion/releases/tag/v0.1.19-bastion). The latest release page is [here](https://github.com/qinyongliang/gosshd-bastion/releases/latest).
