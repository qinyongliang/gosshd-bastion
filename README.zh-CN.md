...
当前公开版本是 [`v0.1.12-bastion`](https://github.com/qinyongliang/gosshd-bastion/releases/tag/v0.1.12-bastion)。最新版本入口在 [GitHub Releases](https://github.com/qinyongliang/gosshd-bastion/releases/latest)。
